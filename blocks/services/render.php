...
if (empty($services)) {
    $services = [
        ['icon' => 'shield', 'title' => 'امنیت بالا', 'description' => 'با بهترین استانداردهای امنیتی از داده‌های شما محافظت می‌کنیم.'],
        ['icon' => 'chart', 'title' => 'رشد سریع', 'description' => 'کسب و کار شما را با استراتژی‌های هوشمند رشد می‌دهیم.'],
        ['icon' => 'users', 'title' => 'پشتیبانی ۲۴/۷', 'description' => 'تیم پشتیبانی ما همیشه آماده کمک به شماست.'],
    ];
}
...
<section
    ...
    class="dst-block dst-services py-16 lg:py-24"
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid gap-6 lg:gap-8 <?php echo esc_attr($col_classes[$columns] ?? 'lg:grid-cols-3'); ?>">
            <?php foreach ($services as $index => $service): ?>
                <div
                    class="<?php echo $style === 'cards' ? 'bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl' : 'p-6'; ?> transition-all duration-300 group"
                    x-show="shown"
                ...
                >
                    <div class="flex items-start gap-4">
                        <?php if ($show_numbers): ?>
                            <span class="flex-shrink-0 w-12 h-12 rounded-full bg-primary-100 text-primary-600 flex items-center justify-center font-bold text-xl">
                                <?php echo dst_fa_num($index + 1); ?>
                            </span>
                        <?php elseif (!empty($service['custom_icon'])): ?>
                        ...
                        <div class="flex-1">
                            ...
                            <?php if (!empty($service['link'])): ?>
                                <a
                                    ...
                                    class="inline-flex items-center gap-2 mt-4 text-primary-600 font-medium hover:gap-3 transition-all"
                                >
                                    بیشتر بخوانید
...
add_action('acf/init', function() {
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                'key' => 'field_services_numbers',
                'label' => 'نمایش شماره',
                'name' => 'show_numbers',
                'type' => 'true_false',
            ],
            [
                'key' => 'field_services_bg',
                'label' => 'رنگ پس‌زمینه',
                'name' => 'bg_color',
                'type' => 'color_picker',
